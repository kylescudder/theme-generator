      ...
      <div className="bg-white rounded-xl shadow-lg border">
        ...
        <div className="flex flex-col" style={{ backgroundColor: "#f8f9fa" }}>
          ...
          <div className="flex flex-col justify-center px-6 py-8">
            <div className="mb-8">
              <h1 className="text-2xl font-normal text-gray-900 mb-8">Log in to your account</h1>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <Input type="password" className="pl-10 pr-16 h-12 border-gray-300" />
                    <div className="absolute left-3 top-1/2 transform -translate-y-1/2">
      ...
      <div className="bg-white rounded-xl shadow-lg border">
        ...
        <div className="bg-white flex flex-col">
          ...
          <div className="flex">
            ...
            <button className="px-6 py-3 text-gray-500 text-sm">Scheduled</button>
          </div>

          <div className="flex-1">
            {mockJobs.map((job, index) => (
              <div key={index} className="flex items-center p-4 border-b border-gray-100">
                <div className="w-1 h-16 rounded-full mr-4" style={{ backgroundColor: "#fbbf24" }} />
                <div className="flex-1 min-w-0">
                  <h3 className="font-semibold text-gray-900 text-base mb-1">{job.title}</h3>
                  <p className="text-sm text-gray-600 mb-1 truncate">{job.client}</p>
          ...
          <div className="flex border-t bg-white">
            <div className="flex-1 text-center py-3 relative">
              <div className="relative inline-block">
                <BarChart3 className="w-6 h-6 mx-auto mb-1" style={{ color: colors.primary }} />
                <div
                ...
                {mockCustomers.map((customer, index) => (
                  <div key={index} className="flex items-center justify-between p-3 hover:bg-gray-50 rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="font-medium text-base text-gray-900">{customer.name}</span>
                    </div>
      ...
      <div className="bg-white rounded-xl shadow-lg border">
        ...
        <div className="bg-gray-50 flex flex-col relative">
          ...
          <div className="flex bg-white border-b">
            ...
            <button className="px-6 py-3 text-gray-500 text-base">History</button>
            <button className="px-6 py-3 text-gray-500 text-base">Resources</button>
          </div>
          ...
          <div className="flex-1 p-4 pb-20">
            ...
            <div className="border-2 border-dashed rounded-lg p-8 mb-6" style={{ borderColor: colors.primary }}>
              <div className="text-center">
                <div className="text-2xl mb-2" style={{ color: colors.primary }}>
                  +
                </div>
                ...
                {Array.from({ length: 3 }).map((_, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-white rounded-lg border">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className="font-medium text-base">[AG] Info Label</div>
                        <div className="text-sm text-gray-500">
                          {index === 0 ? "12/02/25 • 10:57" : index === 1 ? "12/02/25 • 10:54" : "12/02/25 • 10:53"}
                        </div>
                      </div>
                    </div>
                    <ChevronRight className="w-5 h-5 text-gray-400" />
